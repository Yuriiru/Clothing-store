...
public class Product {
    ...
    @Min(value = 1 , message = "Стоимость не может быть отрицательной или нулевой")
    private float price;

    @Column(name = "warehouse", nullable = false)
    @NotEmpty(message = "Поле страны не может быть пустым")
    private String warehouse;

    @Column(name = "seller", nullable = false)
    @NotEmpty(message = "Информация о поставщике не может быть пустой")
